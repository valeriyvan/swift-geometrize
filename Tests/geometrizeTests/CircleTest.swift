...
final class CircleTests: XCTestCase {
    ...
    func testRasterize() throws {
        ...
        bitmap.draw(
            lines:
                Circle(canvasBoundsProvider: canvasBoundsProvider, x: 250.0, y: 250.0, r: 275.0)
        ...
        bitmap.draw(
            lines:
                Circle(canvasBoundsProvider: canvasBoundsProvider, x: 330.0, y: 330.0, r: 250)
                .rasterize(xMin: 0, yMin: 0, xMax: xMax, yMax: yMax),
            color:
        ...
        bitmap.draw(
            lines:
                Circle(canvasBoundsProvider: canvasBoundsProvider, x: 0.0, y: 0.0, r: 133.5)
                .rasterize(xMin: 0, yMin: 0, xMax: xMax, yMax: yMax),
            color:
        ...
        bitmap.draw(
            lines:
                Circle(canvasBoundsProvider: canvasBoundsProvider, x: 499.0, y: 0.0, r: 77.0)
                .rasterize(xMin: 0, yMin: 0, xMax: xMax, yMax: yMax),
            color:
                .magenta
        )
        bitmap.draw(
            lines:
                Circle(canvasBoundsProvider: canvasBoundsProvider, x: 250.0, y: 250.0, r: 100.0)
                .rasterize(xMin: 0, yMin: 0, xMax: xMax, yMax: yMax),
            color:
                .cyan
        )
